...
if (room == rm_startmenu) {
	draw_text_ext_transformed(x,y+10,@"START",48,sprite_width*(1/0.32),0.5, 0.5, 0);
	if (mouse_check_button_pressed(mb_left) && collision_point(mouse_x,mouse_y,obj_optionbox,false,false)) {
		room_goto(rm_green);
	}
} else if(choices == 0){
